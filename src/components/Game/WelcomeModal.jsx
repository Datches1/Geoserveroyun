            ...
            <ul>
              {difficulty === 'normal' ? (
                <>
                  ...
                  <li>⭐ Premium players get <strong>1.25x score multiplier</strong> (+12 points)</li>
                ...
                <>
                  ...
                  <li>✅ Each correct answer: <strong>+15 points</strong> and <strong>+1 second</strong></li>
                  <li>⭐ Premium players get <strong>1.25x score multiplier</strong> (+19 points)</li>
