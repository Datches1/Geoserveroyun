...
const GameMap = ({ 
  ...
  useEffect(() => {
    ...
    const styleFunction = (feature) => {
      ...
      const correctLower = correctProvince ? correctProvince.toLocaleLowerCase('tr-TR') : '';
      
      // Check if this is the correct province for hint
      const isCorrectProvince = showHint && correctProvince && fNameLower.includes(correctLower);
  ...
  }, [provinceOptions, clickedProvince, clickedProvinceCorrect, hoveredProvince, showHint, correctProvince]);
